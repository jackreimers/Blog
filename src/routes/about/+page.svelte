...
<div class="mb-5 flex gap-3 sm:gap-4">
	...
	<div class="flex flex-col justify-between gap-3 sm:gap-4 xl:justify-normal">
...
<div class="mb-5 flex">
	...
	<div class="py-2 pl-3.5">
		<p class="mb-0.5 text-2xl font-bold md:text-4xl">Jack Reimers</p>
