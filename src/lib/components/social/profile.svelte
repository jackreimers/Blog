...
<a href="https://www.linkedin.com/in/jackreimers" class="flex items-center gap-3">
	<div class="h-[64px] w-[64px] rounded-full border border-gray-300 bg-cover" style="background-image: url({url})" />
	<div>
